...
%>
	...
	<tr> 
		<td align="right" width="450"><A href="list02.jsp?go=<%= request.getParameter("page")%>">목록</a></td>
		<td width="70" align="right"><A href="rwrite.jsp?idx=<%= request.getParameter("idx") %>&page=<%= request.getParameter("page") %>">답변</A></td>
